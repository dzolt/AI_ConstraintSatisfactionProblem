...
public class RightNeighbourConstraintArc extends Arc<EinsteinVariable, EinsteinDomain> {

    public RightNeighbourConstraintArc(EinsteinVariable variable1, EinsteinVariable variable2) {
    ...
    public boolean isConstraintSatisfied(EinsteinDomain valueToCheck, List<EinsteinDomain> domainOfRightVariable) {
        return domainOfRightVariable.stream().anyMatch(value -> value.getNumber() == (valueToCheck.getNumber() - 1));
    }
}
