...
public class LeftNeighbourConstraintArc extends Arc<EinsteinVariable, EinsteinDomain> {

    public LeftNeighbourConstraintArc(EinsteinVariable variable1, EinsteinVariable variable2) {
